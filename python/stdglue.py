...
def change_prolog(self, **words):
    try:
        ...
        self.params["tool_in_spindle"] = int(self.current_tool)
        self.params["selected_tool"] = int(self.selected_tool)
        self.params["current_pocket"] = int(self.current_pocket) # this is probably nonsense
        self.params["selected_pocket"] = int(self.selected_pocket)
        return INTERP_OK
    except Exception, e:
